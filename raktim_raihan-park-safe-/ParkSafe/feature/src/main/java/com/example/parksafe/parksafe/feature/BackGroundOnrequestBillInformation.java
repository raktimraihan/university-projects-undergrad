...
public class BackGroundOnrequestBillInformation extends AsyncTask<String,Void,String> {
    private Context ctx;
    private String driver_id,renter_id,json_string;
    BackGroundOnrequestBillInformation(Context ctx){
        this.ctx=ctx;
    }
    ...
    protected String doInBackground(String... params) {
        driver_id=params[0];
        renter_id=params[1];
        String url= "http://raktimprova.apps19.com/PHP/billInformation.php";
        ...
        try {
            ...
            int count=0;
            String date="",lastFourPhn="",trans="",flag="";
            ...
            return date+";.;"+lastFourPhn+";.;"+trans+";.;"+flag;
