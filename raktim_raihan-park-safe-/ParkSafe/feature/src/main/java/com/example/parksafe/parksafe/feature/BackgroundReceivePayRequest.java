...
public class BackgroundReceivePayRequest extends AsyncTask<String, Void, Void> {

    private Context ctx;
    private  String driver_id,renter_id;

    BackgroundReceivePayRequest(Context ctx){
        this.ctx=ctx;
    }
    ...
    protected Void doInBackground(String... params) {
        ...
        String url= "http://raktimprova.apps19.com/PHP/billreceiveRequest.php";
