...
public class BackGroundStayingAfterArrival extends AsyncTask<String,Void,String> {
    private Context ctx;
    String json_string;

    BackGroundStayingAfterArrival(Context ctx){
        this.ctx=ctx;
    }
    ...
    protected String doInBackground(String... params) {
        ...
        String url= "http://raktimprova.apps19.com/PHP/stayingUponArrival.php";
