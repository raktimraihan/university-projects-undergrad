...
public class BackGroundSpaceFree extends AsyncTask<String ,Void,String> {
    private Context ctx;
    private String driver_id,renter_id,line,result="";
    BackGroundSpaceFree(Context ctx){
        this.ctx=ctx;
    }
    ...
    protected String doInBackground(String... strings) {
        ...
        String url= "http://raktimprova.apps19.com/PHP/spacefree.php";
