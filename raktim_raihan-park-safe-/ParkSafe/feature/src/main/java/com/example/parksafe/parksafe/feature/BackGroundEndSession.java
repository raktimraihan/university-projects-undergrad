...
public class BackGroundEndSession extends AsyncTask<String, Void, Void> {

    private Context ctx;
    private String driver_id,renter_id,json_string,time;
    BackGroundEndSession(Context ctx){
        this.ctx=ctx;
    }
    ...
    protected Void doInBackground(String... params) {
        ...
        String url= "http://raktimprova.apps19.com/PHP/endSession.php";
        try {
            ...
            String post_data = URLEncoder.encode("renter_id", "UTF-8") + "=" + URLEncoder.encode(renter_id, "UTF-8") + "&"
                    ...
                    + URLEncoder.encode("timeNow", "UTF-8") + "=" + URLEncoder.encode(time, "UTF-8");
