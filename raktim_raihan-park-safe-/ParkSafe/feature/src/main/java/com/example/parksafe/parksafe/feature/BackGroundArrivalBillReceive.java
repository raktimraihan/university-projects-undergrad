...
public class BackGroundArrivalBillReceive extends AsyncTask<String,Void,Void> {

    private Context ctx;
    private  String driver_id,renter_id;

    BackGroundArrivalBillReceive(Context ctx){
        this.ctx=ctx;
    }
    ...
    protected Void doInBackground(String... params) {
        ...
        String url= "http://raktimprova.apps19.com/PHP/billreceiverArrival.php";
