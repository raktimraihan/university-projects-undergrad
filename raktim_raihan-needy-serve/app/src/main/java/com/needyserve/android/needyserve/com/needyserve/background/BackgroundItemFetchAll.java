...
public class BackgroundItemFetchAll extends AsyncTask<String, Void, Void> {
    ...
    public BackgroundItemFetchAll(Context context, RecyclerView recyclerView, RecyclerView.LayoutManager layoutManager) {
