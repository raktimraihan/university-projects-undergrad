...
import com.needyserve.android.needyserve.Loading;
...
public class BackGroundLoginRL extends AsyncTask<String,Void,String> {
    ...
    protected void onPreExecute() {
        super.onPreExecute();
        url = "http://android.needyserve.org/login.php";
    ...
    protected void onPostExecute(String s) {
        ...
        if(message.equals("Failed")){
            ...
            Intent intent = new Intent(context, LandingNavigationDrawer.class);
