...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Calculators
        <small>are waiting to be shared.</small>
      </h1>
  ...
  <?php
                ...
                $sql = "SELECT * FROM `calculator` order by calculator_id desc limit $page_passed,8  ";
                $sql1 = "SELECT CONCAT(first_name,last_name) as 'Name' FROM `calculator` ,user,`item post`
                        where  `calculator`.`calculator_id`=`item post`.`book_id` and `item post`.`user_id`=user.user_id";
        ...
        <div class="col-lg-3 col-md-4 col-sm-6 portfolio-item">
          <div class="card h-100">
            ...
            <div class="card-body">
              ...
              $sql2 = "SELECT * From\n"
                        . "(\n"
                        . "SELECT CONCAT(first_name,' ',last_name) as \"Name\", `item post`.book_id FROM `calculator` ,user,`item post`\n"
                        . "where  `calculator`.`calculator_id`=`item post`.`book_id` and `item post`.`user_id`=user.user_id) as t where t.book_id= $row[4]";
...
<?php
 ...
 ?>
      ...
      <ul class="pagination justify-content-center">
        <li class="page-item">
          <a class="page-link" href="portfolio-4-col0.php?page_visit=<?php if($_GET["page_visit"]==1){echo 1;}else {echo $_GET["page_visit"]-1;} ?>" aria-label="Previous">
        ...
        for($b=1;$b<=$page;$b++){?>
        <li class="page-item">
          <a class="page-link" href="portfolio-4-col0.php?page_visit=<?php echo $b; ?>"><?php echo $b; ?></a>
        </li>
      <?php }  }
      else{
...
?>
        ...
        <li class="page-item">
          <a class="page-link" href="portfolio-4-col0.php?page_visit=<?php if($_GET["page_visit"]>$page-1){echo 1;}else {echo $_GET["page_visit"]+1;} ?>" aria-label="Next">
