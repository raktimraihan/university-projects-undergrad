...
<?php
                        ...
                        $sql = "SELECT * FROM `blog` order by `date` desc limit $page_passed,8  ";
          ...
          <div class="card mb-4">
            ...
            <div class="card-footer text-muted">
              ...
              <?php
              $sql2 = "select concat(first_name,' ',last_name) FROM user where user.user_id='$row[0]'";
...
<?php                while($row3=mysqli_fetch_row($result3)){ ?>
                    <li>
                      <a href="blog-home-1-search.php?page_visit=1&search=<?php echo $row3[0];?>"><?php echo $row3[0];?></a>
                    </li>
