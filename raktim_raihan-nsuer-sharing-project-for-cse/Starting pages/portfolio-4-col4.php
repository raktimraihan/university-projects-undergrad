...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h1 class="mt-4 mb-3">Other
        <small>items of different category.</small>
      </h1>
      ...
      <div class="row">
        <?php
                      ...
                      $sql = "SELECT * FROM `other` order by item_id desc limit $page_passed,8  ";
                      $sql1 = "SELECT CONCAT(first_name,last_name) as 'Name' FROM `other` ,user,`item post`
                              where  `other`.`item_id`=`item post`.`book_id` and `item post`.`user_id`=user.user_id";
      ...
      <ul class="pagination justify-content-center">
        <li class="page-item">
          <a class="page-link" href="portfolio-4-col4.php?page_visit=<?php if($_GET["page_visit"]==1){echo 1;}else {echo $_GET["page_visit"]-1;} ?>" aria-label="Previous">
        ...
        for($b=1;$b<=$page;$b++){?>
        <li class="page-item">
          <a class="page-link" href="portfolio-4-col4.php?page_visit=<?php echo $b; ?>"><?php echo $b; ?></a>
        </li>
      <?php }  }
      else{
  ...
  ?>
        ...
        <li class="page-item">
          <a class="page-link" href="portfolio-4-col4.php?page_visit=<?php if($_GET["page_visit"]>$page-1){echo 1;}else {echo $_GET["page_visit"]+1;} ?>" aria-label="Next">
